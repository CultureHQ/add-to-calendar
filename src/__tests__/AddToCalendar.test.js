...
test("should show the options menu when the button is clicked", () => {
  var event = {
    title: "Sample Event",
...
test("should show the options menu if optionsOpen is true", () => {
  var event = {
    title: "Sample Event",
    description: "This is the sample event provided as an example only",
    location: "Portland, OR",
...
test("should mount and unmount properly", done => {
