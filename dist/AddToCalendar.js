...
var AddToCalendar = function (_a) {
    var _b = _a.children, children = _b === void 0 ? "Add to My Calendar" : _b, event = _a.event, _c = _a.filename, filename = _c === void 0 ? "download" : _c, _d = _a.showIcon, showIcon = _d === void 0 ? true : _d, handleClick = _a.handleClick, _e = _a.open, initialOpen = _e === void 0 ? false : _e;
    var _f = useOpenState(initialOpen), open = _f[0], onToggle = _f[1];
    ...
    return (react_1.default.createElement("div", { className: "chq-atc" },
        event && (react_1.default.createElement("button", { type: "button", className: "chq-atc--button", onClick: btnClick },
            showIcon && (react_1.default.createElement("svg", { width: "20px", height: "20px", viewBox: "0 0 1024 1024" },
